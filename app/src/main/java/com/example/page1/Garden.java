...
public class Garden extends AppCompatActivity implements CategoryAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query adventureQuery = categoryRef.orderByChild("category").equalTo("Garden");
        ...
        adventureQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Garden.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onItemClick(CategoryModel model) {
        Intent intent = new Intent(Garden.this, Places.class);
