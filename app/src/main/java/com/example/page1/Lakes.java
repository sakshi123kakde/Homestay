...
public class Lakes extends AppCompatActivity implements CategoryAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query adventureQuery = categoryRef.orderByChild("category").equalTo("Lake");
        ...
        adventureQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Lakes.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onItemClick(CategoryModel model) {
        Intent intent = new Intent(Lakes.this, Places.class);
