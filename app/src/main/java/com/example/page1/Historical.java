...
public class Historical extends AppCompatActivity implements CategoryAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query adventureQuery = categoryRef.orderByChild("category").equalTo("Historical");
        ...
        adventureQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Historical.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onItemClick(CategoryModel model) {
        Intent intent = new Intent(Historical.this, Places.class);
