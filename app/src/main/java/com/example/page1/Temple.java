...
public class Temple extends AppCompatActivity implements CategoryAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query adventureQuery = categoryRef.orderByChild("category").equalTo("Temple");
        ...
        adventureQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Temple.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onItemClick(CategoryModel model) {
        Intent intent = new Intent(Temple.this, Places.class);
