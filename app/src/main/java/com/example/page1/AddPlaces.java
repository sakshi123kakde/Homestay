...
public class AddPlaces extends AppCompatActivity {
            ...
            ref.putFile(filePath)
                                ...
                                public void onSuccess(
                                    ...
                                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            Toast.makeText(AddPlaces.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AddPlaces.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void saveDataToDatabase(String imageUrl) {
        ...
        String key = database.child("Places").push().getKey();
        ...
        dataMap.put("category", category); // Save the selected category
        dataMap.put("imageUrl", imageUrl);

        // Save the data under the generated key
        database.child("Places").child(key).setValue(dataMap)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Failed to save data
                        Toast.makeText(AddPlaces.this, "Failed to Save Data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
